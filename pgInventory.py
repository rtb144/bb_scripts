...
from azure.mgmt.postgresqlflexibleservers.models import Server
...
class PostgreSQLPermissionAuditor:
    ...
    def get_all_servers(self) -> List[Server]:
        ...
        servers = []
        try:
            for server in self.postgresql_client.servers.list():
